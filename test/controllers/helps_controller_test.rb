...
class HelpsControllerTest < ActionController::TestCase
  ...
  test "should create help" do
    assert_difference('Help.count') do
      post :create, help: { access_level: @help.access_level, anchor_id: @help.anchor_id, body: @help.body, category: @help.category, title: @help.title }
    end
  ...
  test "should update help" do
    patch :update, id: @help, help: { access_level: @help.access_level, anchor_id: @help.anchor_id, body: @help.body, category: @help.category, title: @help.title }
    assert_redirected_to help_path(assigns(:help))
  end
